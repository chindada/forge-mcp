...
def load_prompt(name: str) -> str:
    """Load a stage prompt by name from the package resources (§12).

    Design: §12 prompts are file-based handoff content, versioned with the code
